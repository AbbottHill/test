...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/css/jquery-ui.css" />
    <link rel="stylesheet" type="text/css" href="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/css/webim_demo.css" />
    <link rel="stylesheet" type="text/css" href="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/css/bootstrap-table.css" />
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" onkeydown="if(event.keyCode==13)return false;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="login_account" value="demo" placeholder="请输入identifier" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" id="login_pwd"
                                   value="eJxFkF1vgjAYhf8L18tSaqt1dwzdBjoFP2a8aoot0Ci0KxVZlv33sUay2*fJm3PO**3tlttHprXklFk6Mtx78oD34LDotDSCstwK02MfYwwBGGwrTCNV3QsIfOzDEQD-UnJRW5lLd8hFpe68kUUP3ufHMEpnJFiFk9WkTT-V4bjIP24meUFhvLsUJMkCtplL1l2yWXwjRVQGazTd87Kq3uLrOnptpmXWPbcLq4u9VKk9bJLleazINhYqH8L4mbppf*VRX44gfzw0tLISbhREAEGEyZ2z00lda0vtlxbuFz*-i9VYNA__"
...
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/jquery/jquery.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/jquery/jquery-ui.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/lodash.min.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/bootstrap/bootstrap.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/bootstrap/bootstrap-table.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/bootstrap/bootstrap-collapse.js"></script>
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/xss.js"></script>
...
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/lib/md5/spark-md5.js"></script>
<!--web im sdk-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/sdk/webim.js"></script>
<!--<script type="text/javascript" src="sdk/webim.min.js"></script>-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/sdk/json2.js"></script>

<!--web im sdk 登录 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/login/login.js"></script>
<!--web im sdk 登出 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/logout/logout.js"></script>
<!--web im 解析一条消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/common/show_one_msg.js"></script>
<!--web im demo 基本逻辑-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/base.js"></script>
<!--web im sdk 资料管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/profile/profile_manager.js"></script>
<!--web im sdk 好友管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/friend/friend_manager.js"></script>
<!--web im sdk 好友申请管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/friend/friend_pendency_manager.js"></script>
<!--web im sdk 好友黑名单管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/friend/friend_black_list_manager.js"></script>
<!--web im sdk 最近联系人 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/recentcontact/recent_contact_list_manager.js"></script>
<!--web im sdk 群组管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/group/group_manager.js"></script>
<!--web im sdk 群成员管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/group/group_member_manager.js"></script>
<!--web im sdk 加群申请管理 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/group/group_pendency_manager.js"></script>
<!--web im 切换聊天好友或群组 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/switch_chat_obj.js"></script>
<!--web im sdk 获取c2c获取群组历史消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/get_history_msg.js"></script>
<!--web im sdk 发送普通消息(文本和表情) api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/send_common_msg.js"></script>
<!--web im sdk 上传和发送图片消息 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/upload_and_send_pic_msg.js"></script>
<!--web im sdk 上传和发送文件消息 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/upload_and_send_file_msg.js"></script>
<!--web im sdk 切换播放语音消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/switch_play_sound_msg.js"></script>
<!--web im sdk 发送自定义消息 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/send_custom_msg.js"></script>
<!--web im sdk 发送群自定义通知 api 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/send_custom_group_notify_msg.js"></script>
<!--web im 监听新消息(c2c或群) 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/receive_new_msg.js"></script>
<!--web im 监听群系统通知消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/receive_group_system_msg.js"></script>
<!--web im 监听好友系统通知消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/receive_friend_system_msg.js"></script>
<!--web im 监听资料系统通知消息 示例代码-->
<script type="text/javascript" src="<%=MyPropertyPlaceholder.staticResourceUrl()%>/static/chartroom/js/msg/receive_profile_system_msg.js"></script>
...
<script type="text/javascript">
    ...
    //默认好友头像
    var friendHeadUrl = contextPath + '/static/chartroom/img/friend.jpg'; //仅demo使用，用于没有设置过头像的好友
    //默认群头像
    var groupHeadUrl = contextPath + '/static/chartroom/img/group.jpg'; //仅demo使用，用于没有设置过群头像的情况
